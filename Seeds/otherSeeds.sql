...
INSERT INTO businesses(id,name,add1,add2,city,st,zip,phone,website,email,oId,createdAt,updatedAt,ownerId) VALUES (1,"BarFood","1234 Habersham","P.O. Box 1","Savannah","GA",31405, 1234567890,"barfood.com","johny@barfood.com",1,NOW(),NOW(),1);
...
INSERT INTO days(id,day,open,close,bId,createdAt,updatedAt,RestrictionId) VALUES (1,"Monday",9,9,1,NOW(),NOW(),1);

INSERT INTO restrictions(id,mask,distancing,gloves,hWashing,temp,cOut,dThru,lServices,pSanitized,tested,bId,createdAt,updatedAt,ChangeId) VALUES (1,false,false,false,false,false,false,false,false,false,false,1,NOW(),NOW(),1);